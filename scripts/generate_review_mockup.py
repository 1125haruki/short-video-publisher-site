...
def slide_homepage() -> Image.Image:
    img = base_canvas()
    draw = ImageDraw.Draw(img)
    browser(draw, "Short Video Publisher public website", "https://1125haruki.github.io/short-video-publisher-site/")
...
def slide_console() -> Image.Image:
    img = base_canvas()
    draw = ImageDraw.Draw(img)
    browser(draw, "Short Video Publisher publisher workspace", "https://1125haruki.github.io/short-video-publisher-site/workspace.html")
...
def slide_session() -> Image.Image:
    img = base_canvas()
    draw = ImageDraw.Draw(img)
    browser(draw, "Connected creator session", "https://1125haruki.github.io/short-video-publisher-site/workspace.html?connected=1")
...
def slide_upload() -> Image.Image:
    img = base_canvas()
    draw = ImageDraw.Draw(img)
    browser(draw, "Review TikTok posting settings", "https://1125haruki.github.io/short-video-publisher-site/workspace.html")
...
def slide_status() -> Image.Image:
    img = base_canvas()
    draw = ImageDraw.Draw(img)
    browser(draw, "Publish status after sending content", "https://1125haruki.github.io/short-video-publisher-site/tour.html")
    code_block(
        draw,
        96,
        238,
